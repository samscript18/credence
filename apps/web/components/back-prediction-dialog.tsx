            ...
            <div className="py-8 text-center space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  Your filled DreamDEX trade was confirmed and linked to this prediction call.
                </p>
              </div>
            ...
            <>
              ...
              <div className="rounded-xl border border-white/5 bg-white/[0.02] p-4 space-y-3 font-mono">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-sm font-semibold ${prediction.direction === "UP" ? "text-emerald-400" : "text-rose-400"}`}>
                ...
                <div className="grid grid-cols-2 gap-3 border-t border-white/5 pt-3 text-xs">
                  <div>
                    ...
                    <span className="text-foreground font-medium mt-0.5 block">
                      {Math.round(prediction.marketProbabilityAtEntry * 1000) / 10}%
                    </span>
                  </div>
                  <div>
                    <span className="text-muted text-[10px] block">Current DreamDEX</span>
                    <span className="text-signal font-medium mt-0.5 block">
                      {currentProbability === null ? "—" : `${Math.round(currentProbability * 1000) / 10}%`}
                    </span>
                  </div>
                </div>
              </div>
              ...
              {busy && (
                <TransactionStepper
                  steps={Object.values(labels)}
                  current={labels[stage as Exclude<Stage, "IDLE" | "SUCCESS">]}
                />
              )}
              ...
              {pendingHash ? (
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className="brand-button w-full cursor-pointer disabled:opacity-40"
                  >
              ...
              <p className="text-center font-mono text-[10px] text-muted/60">
                This creates your own position on DreamDEX Event Contracts.
              </p>
            </>
          )}
        </div>
