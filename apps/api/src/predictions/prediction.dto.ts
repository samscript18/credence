...
export function toPredictionDto(prediction: PredictionDocument): CredencePrediction {
  return {
    ...
    autoClaimEnabled: prediction.autoClaimEnabled,
    ...(prediction.autoClaimStatus ? { autoClaimStatus: prediction.autoClaimStatus } : {}),
    ...(prediction.autoClaimReason ? { autoClaimReason: prediction.autoClaimReason } : {}),
    ...(prediction.keeperhubExecutionId ? { keeperhubExecutionId: prediction.keeperhubExecutionId } : {}),
    ...(prediction.autoClaimVerifiedAt ? { autoClaimVerifiedAt: prediction.autoClaimVerifiedAt.toISOString() } : {}),
    ...(prediction.autoClaimRecovered ? { autoClaimRecovered: prediction.autoClaimRecovered } : {}),
